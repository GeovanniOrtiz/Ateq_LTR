...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_Label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700; color:#b4b4b4;\">TESTING</span></p></body></html>", None))
        self.box_label.setItemText(0, QCoreApplication.translate("MainWindow", u"ACTIVADO", None))
        self.box_label.setItemText(1, QCoreApplication.translate("MainWindow", u"DESACTIVADO", None))
