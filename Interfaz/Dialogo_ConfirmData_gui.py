...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_PartNo.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700; color:#0055ff;\">5QM121251R</span></p></body></html>", None))
        ...
        self.lbl_Cantidad.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700; color:#0055ff;\">16</span></p></body></html>", None))
        ...
        self.OT.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700; color:#d1d1d1;\">Fecha:</span></p></body></html>", None))
